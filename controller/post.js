...
// 创建文章
const createPost = ({title, content, image, editor, createdAt, columnId}) => {
  const sql = `insert into table_post(title, content, image, editor, createdat, columnid) values('${title}', '${content}', '${image}', '${editor}', '${createdAt}', '${columnId}')`
